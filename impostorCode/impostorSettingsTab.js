const removeSVG = `<svg class="removeButtonSVG" width="${document.body.clientHeight*0.04}" height="${document.body.clientHeight*0.04}" viewBox="0 0 118 118" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const addPlayer = () => {
    ...
    newPlayerElement.style.top = (players.length * 10)+"vh";
    ...
    removeButton.addEventListener('click',() => {
        ...
        for(let i in playerElementHolder.childNodes){
            let elem = playerElementHolder.childNodes[i];
            if(elem.style) elem.style.top = (i * 10) + "vh";
        }
...
const addWord = (wordValue = '') => {
    ...
    newWordElement.style.top = (words.length * 10)+"vh";
